...
namespace CsTester
{
  public partial class Form1 : Form
  {
    ...
    private void buttonStandard_Click(object sender, EventArgs e)
    {
      ...
      TestType[,] arr2 = Enumerator.Generate(15, (X) => new TestType() { a = X, b = X - 5 }).Shuffle().ToArray(5, 3);
    ...
    {
      return new int[][] { new int[] { 1, 2, 3, 4 }, new int[] { 1, 2, 3 }, new int[] { 1, 2, 3, 4, 5 }, new int[] { 1, 2, 3, 4, 6, 7, 8, 89 } };
    }
